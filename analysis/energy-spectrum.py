...
def doit(ds):
    ...
    #dd.quantities.extrema("grid_indices")       #ds.index.max_level
    ...
    dims = ds.domain_dimensions    #*ref   it is possible ref stands for refinement and refinement factor. 
...
if __name__ == "__main__":
    ...
    ds = yt.load("/mnt/scratch/shinjasm/newrun3/newrun3-4/id0/TaylorGreen3.0250.vtk")
doit(ds)
